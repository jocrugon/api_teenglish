...
from teenglish.api.serializers.exercise_serializers import ExerciseSerializer, ExerciseByCategorySerializer, OptionsByExerciseSerializer
from teenglish.models import List_exercises_category, List_options_exercise, Exercise
